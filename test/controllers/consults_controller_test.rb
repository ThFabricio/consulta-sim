...
class ConsultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consult" do
    assert_difference("Consult.count") do
      post consults_url, params: { consult: { data: @consult.data, horario: @consult.horario } }
    end
  ...
  test "should update consult" do
    patch consult_url(@consult), params: { consult: { data: @consult.data, horario: @consult.horario } }
